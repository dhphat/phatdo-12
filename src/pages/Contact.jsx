...
const TiktokIcon = ({ size = 18 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.525.02c1.31-.032 2.617-.023 3.91-.023.24 3.112 2.32 5.167 4.395 5.627v3.172a8.13 8.13 0 0 1-3.736-2.207l-.073-.074V15.56c0 3.86-2.617 7.047-7.234 7.234-4.242.067-7.266-2.868-7.266-7.147 0-3.92 3.066-7.274 7.323-7.235.18 0 .358.012.534.037v3.276c-.168-.037-.34-.056-.512-.056-1.894-.031-4.027 1.258-4.027 3.965 0 2.503 1.933 3.94 3.935 3.94 2.872 0 3.737-1.464 3.737-4.103V.02z" />
    </svg>
);
